package jtk.springboot.mysql.sakila.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"jtk.springboot.mysql.sakila.entities"})
@Configuration
public class MySqlSakilaDataSourceConfig {

    @Value("${spring.ds_mysql.sakila.url}")
    private String url;
    ...
    public EntityManagerFactory entityManagerFactory() throws Exception {
        ...
        emf.setPackagesToScan("jtk.springboot.mysql.sakila.entities");
